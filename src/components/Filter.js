        ...
        <select name="cars" id="cars" className="customDropdown">
          ...
          <TextField
              ...
              />
                    ...
                    <div id = "middlebox" className="defaultMargin">
          ...
          <Button variant="contained" disableElevation style={{width:"100%",marginTop:"40px"}}>
              Search
            </Button>
          </div>
          <div style={{margin:'auto'}}><img style={{width:"100%",height:'350px'}} src="https://images.unsplash.com/photo-1546552768-2e5b568b0680?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=871&q=80" alt="beachImg"/></div>
          </div>;
        </div>
      )
    }
